...
import { PANEL_STYLE } from "@lichtblick/suite-base/panels/ThreeDeeRender_custom/constants";
 ...
 */
export function ThreeDeeRender_custom(props: Readonly<ThreeDeeRenderProps>): React.JSX.Element {
  const {
    context,
    interfaceMode,
    testOptions,
