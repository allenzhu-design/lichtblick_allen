 ...
 * RendererContext. This will always return undefined from the ThreeDeeRender_custom()
 * component since the context exists below ThreeDeeRender_custom().
 */
 ...
 * ThreeDeeRender_custom() component which is above the RendererContext.
