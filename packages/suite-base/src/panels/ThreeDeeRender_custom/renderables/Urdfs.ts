...
import { makeRgba, stringToRgba } from "@lichtblick/suite-base/panels/ThreeDeeRender_custom/color";
...
export class Urdfs extends SceneExtension<UrdfRenderable> {
  ...
  public override getSubscriptions(): readonly AnyRendererSubscription[] {
    return [
      ...
      // topic list that can have its visibility toggled on. The ThreeDeeRender_custom subscription logic
