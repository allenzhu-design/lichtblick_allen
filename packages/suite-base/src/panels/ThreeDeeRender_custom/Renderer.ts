...
import { HUDItemManager } from "@lichtblick/suite-base/panels/ThreeDeeRender_custom/HUDItemManager";
import { LayerErrors } from "@lichtblick/suite-base/panels/ThreeDeeRender_custom/LayerErrors";
import { ICameraHandler } from "@lichtblick/suite-base/panels/ThreeDeeRender_custom/renderables/ICameraHandler";
...
export class Renderer extends EventEmitter<RendererEvents> implements IRenderer {
  ...
  #clickHandler = (cursorCoords: THREE.Vector2): void => {
    ...
    if (this.measurementTool.state !== "idle" || this.selectionTool.state !== "idle" || this.publishClickTool.state !== "idle") {
      return;
    }
