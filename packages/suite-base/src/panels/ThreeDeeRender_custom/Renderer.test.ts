...
import { Renderer } from "@lichtblick/suite-base/panels/ThreeDeeRender_custom/Renderer";
import { DEFAULT_SCENE_EXTENSION_CONFIG } from "@lichtblick/suite-base/panels/ThreeDeeRender_custom/SceneExtensionConfig";
import { DEFAULT_CAMERA_STATE } from "@lichtblick/suite-base/panels/ThreeDeeRender_custom/camera";
import { CameraStateSettings } from "@lichtblick/suite-base/panels/ThreeDeeRender_custom/renderables/CameraStateSettings";
import { DEFAULT_PUBLISH_SETTINGS } from "@lichtblick/suite-base/panels/ThreeDeeRender_custom/renderables/PublishSettings";
import { TFMessage } from "@lichtblick/suite-base/panels/ThreeDeeRender_custom/ros";
...
beforeEach(() => {
  ...
  // mock matchMedia for `Renderer` class in ThreeDeeRender_custom
